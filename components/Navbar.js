...
const Navbar = () => {
  ...
  return (
    <>
      {showNavbar && (
        <nav className="bg-white flex justify-between right-[7vw] w-[85vw] fixed top-10 mx-auto rounded-full h-[12vh] px-7">
          ...
          <div className="flex items-center gap-3">
            <button className="login bg-gray-200 p-4 rounded-lg font-bold">
              Log in
            </button>
